    ...
    const fetchScores = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:3000/api/scores/leaderboard?game=game1&all=true"
        );
        console.log("Response for 2048:", {
        ...
        if (!contentType || !contentType.includes("application/json")) {
          ...
          console.error("Non-JSON response for 2048:", text);
  ...
  return (
    <>
      ...
      <div className="container my-4">
        <h2 className="text-center mb-4">2048 Leaderboard</h2>
